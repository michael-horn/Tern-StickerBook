...
/**
 * Abstract class representing a "robot" that can control a physical
 * or virtual agent and run programs on that agent.
 */
public abstract class Robot implements Debugger {
